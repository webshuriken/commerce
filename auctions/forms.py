...
class NewListingForm(forms.Form):
    title = forms.CharField(label="Title", max_length=256, widget=forms.TextInput(attrs={'placeholder': 'Enter listing title'}))
    description = forms.CharField(label="Description", max_length=1024, widget=forms.Textarea(attrs={'placeholder': 'Describe your listing'}))
